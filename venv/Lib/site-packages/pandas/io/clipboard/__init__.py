...
def lazy_load_stub_copy(text):
    """
    A stub function for copy(), which will load the bytes copy() function when
    called so that the bytes copy() function is used for later calls.
...
def lazy_load_stub_paste():
    """
    A stub function for paste(), which will load the bytes paste() function when
    called so that the bytes paste() function is used for later calls.
...
# set `copy` and `paste` to bytes functions the first time they're used, unless
