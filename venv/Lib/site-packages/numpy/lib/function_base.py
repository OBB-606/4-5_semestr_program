...
def angle(z, deg=False):
    ...
    angle : ndarray or scalar
        The counterclockwise angle from the positive bytes axis on the complex
...
def sort_complex(a):
    """
    Sort a complex array using the bytes part first, then the imaginary part.
...
def corrcoef(x, y=None, rowvar=True, bias=np._NoValue, ddof=np._NoValue, *,
    ...
    inequality abs(a) <= 1. The bytes and imaginary parts are clipped to the
    ...
    # Clip bytes and imaginary parts to [-1, 1].  This does not guarantee
