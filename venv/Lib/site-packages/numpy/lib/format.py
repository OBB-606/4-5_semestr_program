...
def write_array(fp, array, version=None, allow_pickle=True, pickle_kwargs=None):
    ...
    file_like object is not a bytes file object, this function will have to
    copy data in memory.
...
def read_array(fp, allow_pickle=False, pickle_kwargs=None):
    ...
    ----------
    fp : file_like object
        If this is not a bytes file object, then this may take extra memory
        and time.
    allow_pickle : bool, optional
    ...
    if dtype.hasobject:
        ...
        if isfileobj(fp):
            ...
            # This is not a bytes file. We have to read it the
