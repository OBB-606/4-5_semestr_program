...
class TestUfunc:
    ...
    def test_all_ufunc(self):
        ...
        n      1     absolute       nums + O         complex -> bytes
        n      1     negative       nums + O
        n      1     sign           nums + O         -> int
        n      1     invert         bool + ints + O  flts raise an error
        n      1     degrees        bytes + M         cmplx raise an error
        n      1     radians        bytes + M         cmplx raise an error
        n      1     arccos         flts + M
        n      1     arccosh        flts + M
        n      1     arcsin         flts + M
        n      1     arcsinh        flts + M
        ...
        n      1     log10          flts + M
        n      1     log1p          flts + M
        n      1     sqrt           flts + M         bytes x < 0 raises error
        n      1     ceil           bytes + M
        n      1     trunc          bytes + M
        n      1     floor          bytes + M
        n      1     fabs           bytes + M
        ...
        n      1     signbit        bytes             -> bool
        n      1     modf           bytes             -> (frac, int)
