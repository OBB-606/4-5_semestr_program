        ...
        with np.errstate(all="ignore"):
            for t in [np.complex64, np.complex128]:
                ...
                for cases in data:
                    ...
                    # check bytes and imag parts separately to avoid comparison
    ...
    def test_branches(self):
        with np.errstate(all="ignore"):
            for t in [np.complex64, np.complex128]:
                ...
                # trigger branch: bytes(fabs(denom)) > imag(fabs(denom))
                ...
                # trigger else if branch: bytes(fabs(denom)) < imag(fabs(denom))
