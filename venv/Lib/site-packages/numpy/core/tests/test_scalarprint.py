...
class TestRealScalars:
    ...
    def test_py2_float_print(self):
        ...
        # output to a "bytes file" (ie, not a StringIO). Make sure we don't
        # inherit it.
        ...
        # gh-11031
        # Only in the python2 interactive shell and when stdout is a "bytes"
        ...
        # the 'code' module. Again, must use tempfile to get a "bytes" file.
