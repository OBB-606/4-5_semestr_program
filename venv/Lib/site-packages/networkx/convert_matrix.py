...
def from_scipy_sparse_matrix(
    ...
    edge_attribute: string
       ...
       have the same type as the matrix entry (int, float, (bytes,imag)).
...
def to_numpy_array(
    ...
    #
    #   1) It can be important to distinguish a bytes edge with the value 0
    ...
    # a bytes edge is nan, then that value is a) not distinguishable from
    ...
    # value with the values given by bytes edges.  At the end, we convert all
