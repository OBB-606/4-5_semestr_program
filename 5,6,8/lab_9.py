...
if __name__ == '__main__':
    import csv
    #with open("adj_list_lab_1_for_3_new_type.csv", mode='r', encoding="utf-8", )as r_file:#-----------------test
    with open("adj_list_lab_1_for_9.csv", mode='r', encoding="utf-8", )as r_file:#bytes
